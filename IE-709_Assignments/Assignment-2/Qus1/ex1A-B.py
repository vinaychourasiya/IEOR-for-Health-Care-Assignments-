...
def ServiceArea():
    ...
    plt.scatter(x=[6,8,18,12],y=[4,10,7,2],color='yellow')
    plt.savefig("ServiceLocations.png")
    plt.close()
    for i in range(len(CoverPoints)):
        print("No. of pixel covered by "+str(Locations[i])+": ",CoverPoints[i])
...
Locations=np.array([(6,4),(8,10),(18,7),(12,2)])
S=10  
PD=10  
PerformMeasure(S, PD)
